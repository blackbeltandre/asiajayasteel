...
<body>
    ...
    <div class="container">
        ...
        <div class="" id="login-wrapper">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div id="logo-login">
                       <h1 color:="" ff0000="" font:=""  margin:="" style="background-color: transparent;  color: white; text-shadow: 1px 1px 2px black, 0 0 25px black, 0 0 10px white; font-family: Impact;">PT.ASIA JAYA STEEL 
        ...
        <div style="text-align:center;margin:0 auto;">
            <h6 style="color:#fff;">ASIA JAYA STEEL  © <strong> PAB <span>v1.0</span></strong> Development Team <u><?php echo date('Y'); ?></u> </h6>
        </div>
