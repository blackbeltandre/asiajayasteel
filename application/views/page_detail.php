        ...
        <div class="feature-work container my-4">
            <div class="row d-flex d-flex align-items-center">
                <div class="col-lg-5">
                    ...
                    <h1 class="feature-work-heading h2 py-3 semi-bold-600"><?php echo $page_detail['title'];?></h1>
                ...
                <div class="col-lg-6 offset-lg-1 align-left">
                    <div class="row"><img src="<?php echo base_url(); ?>assets/foto/<?php echo $page_detail["foto"]; ?>" alt="" onError="this.onerror=null;this.src='<?php echo base_url();?>assets/foto/foto.png';" class="img-fluid" width="500" height="1000">
                          </div>
